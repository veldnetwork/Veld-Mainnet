...
int main() {
    ...
    try {
        ...
        check(!SelectNmsFundingOutput(outputs, tip, fee, std::numeric_limits<uint64_t>::max(), fee,
                                      dust),
              "required amount overflowed");
