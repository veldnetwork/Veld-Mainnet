...
#error "daybreak_staking_activation_tests requires the public-mainnet profile"
#endif
    ...
    static_assert(MIN_STAKE_UNITS == 1'000ULL * VELD_UNITS,
                  "public-mainnet minimum stake changed");
    ...
    std::cout << "PASS daybreak_staking_activation_tests checks=" << checks
              << " activation_veld="
              << (STAKING_UNLOCK_SUPPLY / VELD_UNITS)
              << " validator_bond_veld="
