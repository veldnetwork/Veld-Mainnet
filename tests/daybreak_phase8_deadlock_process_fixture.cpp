...
#error "PHASE8-DEADLOCK-01 process fixture requires VELD_TEST_HOOKS"
#endif
#if defined(VELD_PUBLIC_RELEASE) || defined(VELD_PUBLIC_MAINNET)
#error "PHASE8-DEADLOCK-01 fixture must never compile in a public profile"
#endif
    ...
    try {
        if (argc != 2)
            throw std::invalid_argument(
                "usage: daybreak_phase8_deadlock_process_fixture <artifact-root>");
        ...
        std::cout << "PHASE8_DEADLOCK_ARMED verified_peers=2 height=0"
                  << std::endl;
        ...
        std::cout << "PHASE8_DEADLOCK_JSON {\"status\":\"pass\","
