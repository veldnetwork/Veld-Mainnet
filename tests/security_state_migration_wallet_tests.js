...
assert.strictEqual(
    challenge(prefix, ...fields.slice(0, 4), 2879, false),
...
console.log(
    'PASS security_state_migration_wallet_tests UTF8_framing=PASS legacy_framing=PASS prepared_marker_binding=PASS',
);
