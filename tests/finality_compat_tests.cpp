...
Hash256 Envelope(bool v8, const Hash256& finality) {
    ...
    if (v8) {
        return state_digest::ComposeV8(91, tip, component, component, component, component,
                                       component, component, component, component, component,
                                       component, component, component, finality, component);
    }
    return state_digest::ComposeV7(91, tip, component, component, component, component, component,
                                   component, component, component, component, component, component,
                                   component, finality, component);
}
...
int main() {
    ...
    CHECK(P2P_FINALITY_VOTE_WIRE_BYTES == finality::wire::SIGNED_VOTE_BYTES);

    const auto bounds = net::Connection::BoundsForCommand(MessageType::FINVOTE);
    ...
    const P2PMessage message = peer_manager.BuildFinalityVoteMessage(canonical_vote);
    ...
    CHECK(std::equal(canonical_vote.begin(), canonical_vote.end(), wire.begin() + 24));
    ...
    const Hash256 finality_a = state_digest::FinalityDigest(77, 1, 64);
    const Hash256 finality_b = state_digest::FinalityDigest(78, 1, 64);
    ...
    std::cout << "PASS finality_compat_tests checks=" << checks
              << " wire_bytes=" << P2P_FINALITY_VOTE_WIRE_BYTES << " v7_v8_domain_separated=1\n";
    return 0;
}
