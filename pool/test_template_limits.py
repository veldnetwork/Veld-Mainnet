...
from pool.protocol import decode, encode, Refused, MAX_BLOCK_BYTES, MAX_RPC_BYTES, MAX_JOURNAL_BYTES
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            if method in ('getblockhash', 'getcompiledgenesis'):
                ...
                result = dict(
                    block_hex=state['block_hex'],
                    height=1,
                    target='f' * 64,
                    prev_block_hash='c' * 64,
                    work_binding='fixture-binding',
                    work_token='private-fixture-token',
                    work_ttl_ms=10000,
                    reserved_miner_destination=False,
                    miner_receipts=[],
                )
