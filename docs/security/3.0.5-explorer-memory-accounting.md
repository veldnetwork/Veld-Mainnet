...
Applies to the hash and height HTML block-page aliases on the isolated 3.0.5
remediation source. This is an engineering allocation model, not measured process RSS.
...
No dense-chain workload, denial-of-service exercise, allocator RSS proof or live
network test was performed. Platform allocator behavior, shared chain caches and
