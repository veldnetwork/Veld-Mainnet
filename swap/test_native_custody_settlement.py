...
class SettlementProofTests(unittest.TestCase):
    def test_reserve_domain_is_distinct_from_rpc_hash_rendering(self):
        policy = {"domain_genesis_hash":"880a0057852ffcfa35119a83e556802848ed5cb469b260fb9fbd20e8b97ae77b",
    ...
    def test_duplicate_unknown_malformed_and_unbounded_blocks_are_refused(self):
        ...
        for rows, wanted in (([], value), ([value, value], value), ([value], '34' * 32),
                ([{}], value), ([None], value), ([value.upper()], value), ([value] * 100001, value)):
    ...
    def test_single_transaction_block_has_no_extra_branch(self):
        value = 'ab' * 32
        self.assertEqual(settlement.merkle_branch([value], value,
            bytes(36) + bytes.fromhex(value)[::-1] + bytes(12)), (0, []))
    ...
    def test_malformed_request_has_no_rpc_or_key_side_effect(self):
        ...
        with patch.object(settlement.authority, 'configuration', return_value={}):
            for request in (None, [], {}, {'action':'native_settlement'},
                    {'action':'native_settlement','authorization_hex':'00','raw_tx_hex':'00','fund_address':False}):
