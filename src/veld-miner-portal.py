...
PORTAL_SERVICE_WORKER = b"""const CACHE='veld-portal-shell-v10';
...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box}html,body{margin:0;min-height:100%;background:var(--bg);color:var(--text);font:14px/1.45 system-ui,-apple-system,"Segoe UI",sans-serif}button,input,select{font:inherit}button{cursor:pointer}.hidden{display:none!important}
    ...
    /* Use the wallet PWA's proven architecture: the desktop sidebar and the
       fixed mobile tab bar are separate elements.  Repositioning the sidebar
       caused iOS to place it against the initial layout viewport on cold start. */
    @media(max-width:900px){
      ...
      #mobile-nav{display:flex!important;position:fixed!important;bottom:0!important;left:0!important;right:0!important;top:auto!important;z-index:1000!important;width:100%!important;height:68px!important;min-height:68px!important;max-height:68px!important;margin:0!important;padding:0!important;background:rgba(14,20,16,.98)!important;border:0!important;border-top:1px solid #28332b!important;box-shadow:none!important;box-sizing:border-box!important;transform:translateZ(0)!important;-webkit-transform:translateZ(0)!important;will-change:transform!important}
      #mobile-nav .mob-tab{flex:1;display:flex;position:relative;min-width:0;height:68px;min-height:68px;max-height:68px;margin:0;padding:7px 2px 6px;border:0;border-radius:0;background:transparent;color:#707c73;appearance:none;-webkit-appearance:none;flex-direction:column;align-items:center;justify-content:center;gap:3px;font:600 10px/1 system-ui,-apple-system,"Segoe UI",sans-serif;letter-spacing:.02em;text-align:center;text-transform:none;-webkit-tap-highlight-color:transparent;touch-action:manipulation;overflow:hidden}
      #mobile-nav .mob-tab.active{color:var(--text)}
      #mobile-nav .mob-tab.active:before{content:"";position:absolute;top:0;left:50%;width:32px;height:2px;transform:translateX(-50%);border-radius:0 0 3px 3px;background:var(--text)}
