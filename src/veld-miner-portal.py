...
function pool(){return `<h2>Veld Pool</h2>
<div class="note em"><strong>Pool status</strong><p id="pool-public-status" role="status">Connecting to Veld Pool…</p></div>
<div class="cards">
<div class="card"><div class="label">Active accounts · last 2 minutes</div><div class="value" id="pool-public-active_accounts">—</div></div>
<div class="card"><div class="label">Verified shares</div><div class="value" id="pool-public-verified_shares">—</div></div>
<div class="card"><div class="label">Reconciled height</div><div class="value" id="pool-public-reconciled_height">—</div></div>
<div class="card"><div class="label">Payments</div><div class="value" id="pool-public-payments">Unknown</div></div>
<div class="card"><div class="label">Co-mining</div><div class="value" id="pool-public-comining">Unknown</div></div>
</div>
<h3>Start pool mining</h3><div class="section"><ol><li>Open Veld Node and select Pool.</li><li>Use <strong>https://pool.veld.network</strong> and enter your own wallet’s payout address.</li><li>Choose your CPU threads, then start mining.</li></ol><p>No deposit, personal stake, or private key is needed. Your PC and laptop can use the same payout address.</p></div>
<h3>Rewards and payment history</h3><div class="section"><p>Open the pool dashboard with your separate account access to see pending, available and paid balances. A payout address alone does not unlock private history.</p><p><span id="pool-public-policy">Loading payment policy…</span> Earned receipts need at least 120 confirmations and must be spendable. Daily processing does not guarantee daily earnings.</p><a class="button" href="https://pool.veld.network" target="_blank" rel="noopener noreferrer">Open pool dashboard →</a></div>
`;}
