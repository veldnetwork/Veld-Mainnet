  ...
  private:
    ...
    void Handle(SocketHandle cfd) {
        ...
        if (signer_bootstrap) {
            ...
            if (body.empty()) {
                result =
                    "{\"jsonrpc\":\"2.0\",\"error\":{\"code\":-32700,\"message\":\"Empty\"},\"id\":null}";
            } else {
