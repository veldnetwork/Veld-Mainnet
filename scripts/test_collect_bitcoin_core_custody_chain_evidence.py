...
SCRIPT = Path(__file__).with_name("collect-bitcoin-core-custody-chain-evidence.py")
...
class CollectorTests(unittest.TestCase):
    ...
    def test_chain_info_requires_synced_main(self) -> None:
        ...
        for mutation in ({"chain": "regtest"}, {"initialblockdownload": True}, {"headers": 900001}):
            bad = dict(valid)
            bad.update(mutation)
